...
public class Squadron {
    ...
    public ConcurrentMap<SquadronCraft, Integer> getCraftMap() {
        return crafts;
    }

    public Set<SquadronCraft> getCrafts() {
    ...
    public int getSize() {
        return (crafts == null) ? (0) : (crafts.size());
    }
    ...
    @Nullable
    public PlayerCraft getCarrier() {
        return carrier;
    }

    public void setCarrier(PlayerCraft c) {
        carrier = c;
    }
    ...
    public void setDirection(CruiseDirection cd) {
        orientation = cd;
    }

    public void setCruising(boolean b) {
        cruising = b;
    }

    public void setCruiseDirection(CruiseDirection cd) {
        cruiseDirection = cd;
    }

    public void setPilotLocked(boolean b) {
        pilotLocked = b;
    }
